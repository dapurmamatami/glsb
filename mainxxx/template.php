          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <li><a href="../my_order/index.php?view=list&sub=AllOrder">Processed Order</a></li>
                <li><a href="../my_order/index.php?view=list&sub=pending">Pending Order</a></li>
...
<li <?php if($_GET['wallet'] == "ewalletWithdraw") { echo "class='active'"; }?>><a href="../wallet/index.php?view=list&wallet=ewalletWithdraw"><?php echo $lang['MENU_E_WALLET_WITHDRAM_HISTORY']; ?></a></li>      
            ...
            <li <?php if($current_folder == "user") { echo "class='active'"; } ?>>
              <a href="#"><i class="fa fa-link"></i> <span>My Downline</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
            <li><a href="../user/index.php?view=list&sub=1"><i class="fa fa-link"></i> <span>Downline Level 1</span></a></li>  
            <li><a href="../user/index.php?view=list&sub=2"><i class="fa fa-link"></i> <span>Downline Level 2</span></a></li>            
            <li><a href="../user/index.php?view=list&sub=3"><i class="fa fa-link"></i> <span>Downline Level 3</span></a></li>
