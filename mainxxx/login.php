...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  else
  {
    ...
    if($temp_password!="")
    {
      header("Location: ../password/index.php?view=detail");
    }
    else
    {
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <!--
       ...
       -->
       <b><?php 
		  $companyData = getCompanyDetailForm(1); 
		  echo $companyData[code]; ?></b>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form action="login.php" method="post">
          ...
          <div class="form-group has-feedback">
           ...
           <div class="form-group has-feedback">
           <select type="text" name="lang"  class="form-control" placeholder="Language">
