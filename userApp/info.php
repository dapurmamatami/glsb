                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box-header with-border">
                          <h3 class="box-title"></h3> 	
        						...
        						<input type="button" value="UPDATE" id="buttonUpdate" class="btn btn-primary" onClick="document.theForm.action='info_inc.php?action=update&id=<?php echo $_SESSION[user_id]; ?>'"/>
                                  ...
                                  <div class="tab-content">
 									...
 									<div class="form-group">												
											<label class="col-md-2 control-label">User ID</label>
											<div class="col-md-3">
												<input type="text" name="user_name" id="user_name" class="form-control" value="<?PHP echo $data['user_name']?>" disabled="disabled"/>
											</div>
