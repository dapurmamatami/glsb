    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#theForm').jqxValidator({
                rules: [
                       { input: '#customer_name', message: 'Username is required!', action: 'keyup, blur', rule: 'required' }]
            });
        });
    </script>
            <!-- Horizontal Form -->
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Horizontal Form</h3>   
                      ...
                      <div style="float: right;">
                        <div style="float: right;">
                         ...
                         <input type="button" value="Addaaaaaaaaaaa" id="sendButton" name="sendButton"  class="btn btn-primary" />
                  ...
                  <div class="box-body">                                   
                    <div class="form-group">
                      ...
                      <div class="col-sm-3">
						<input name="customer_name" type="text" class="form-control" id="customer_name" value="" />
                      </div>
                      <label for="inputEmail5" class="col-sm-2 control-label">Email</label>
                      <div class="col-sm-3">
						<input name="customer_name2" type="text" class="form-control" id="customer_name2" value="" />
                      </div>                      
                    </div>
                    <div class="form-group">
