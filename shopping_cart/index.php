...
<?php		
    foreach ($_SESSION["cart_item"] as $item){
		...
		?>
				...
				<td align=right><?php echo "$".$item["selling_price"]; ?></td>
                <td align=right><?php echo "$".$total; ?></td>
				<td><a href="index.php?action=remove&product_code=<?php echo $item["product_code"]; ?>" class="btnRemoveAction">Remove Item</a></td>
				</tr>
				<?php
...
<div id="product-grid">
	...
	?>
		<div class="product-item">
			...
			<div class="product-price"><?php echo "$".$product_array[$key]["selling_price"]; ?></div>
