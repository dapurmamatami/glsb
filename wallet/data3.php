...
// get data and store in a json array
	...
	if ($user_group == 10)
	{
			...
			$viewAllSQL = 'where acct_ewallet_withdraw_request.user_id = ' . $user_id . '';
			$viewAllSQLFilter = 'and acct_ewallet_withdraw_request.user_id = ' . $user_id . '';	
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM $walletTable left join user on acct_ewallet_withdraw_request.user_id = user.user_id $viewAllSQL LIMIT $start, $pagesize";
