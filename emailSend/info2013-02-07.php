                          ...
                          <td colspan="3" class="formblock_content"><table width="100%" border="0" cellpadding="0" cellspacing="0">
						    ...
						    ?>
                                ...
                                <tr class="formblock_row2 " id="viewrow1">
                                  ...
                                  <td align="left"><input name="send_to" type="text" class="form_txtbox_long" id="send_to" value="<?php if($module == "fault_report") { echo $row_RecordsetMain['email']; if($totalRows_RecordsetEmailAll>0 and $group_mail==1) { do { echo ","; echo $row_RecordsetEmailAll['email'];
