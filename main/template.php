...
<html>
  <head>
	...
	<?php 
		$companyDataCheck = getCompanySetupDetailForm(1);
		$commission_type = $companyDataCheck['commission_type'];
		$commission_period_sw = $companyDataCheck['commission_period_sw'];
    ?>
  ...
  ?> 
    <div class="wrapper">
      ...
      <header class="main-header">
		<?php $companyData2 = getCompanyDetailForm(1); ?>
        <!-- Logo -->
        <a href="../main/index.php" class="logo">
          ...
          <div align="left">
          <span class="logo-lg"><b><?php echo $companyData2[code]; ?></b></span>
          </div>
        </a>
          ...
          <div class="navbar-custom-menu">
			...
			<?php if($_SESSION['user_grp'] != 10){ ?>
              ...
              <li class="dropdown user user-menu">
                ...
                <li><a href="../my_order2/index.php?view=add">New Sales Order</a></li>
                <li><a href="../my_order2/index.php?view=list&sub=pending">Pending Member Order</a></li>
                <li><a href="../my_order2/index.php?view=list&sub=pendingdelivery">Pending Delivery Listing</a></li>
				<?php } ?>
                </ul>
              </li>                                
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                <?php if($commission_type == 2) { //group commission?> 
 				<li><a href="../monthly_sales/index.php?view=list">Monthly Sales Listing</a></li>
				<?php } ?>
                <li><a href="../wallet/index.php?view=listWithdrawRequest">Withdraw Request</a></li>
                <li><a href="../wallet/index.php?view=listWithdrawPending">Pending Withdrawal</a></li>
              ...
              <li class="dropdown user user-menu">
                ...
                <li><a href="../setting/index.php?view=detail&sub=bank_setting">Bank Setting</a></li>
                 <?php if($commission_type == 2) { //group commission?> 
                <li><a href="../percentage/index.php?view=list">Group Percentage</a></li>
                <?php } ?>
                <!--
              ...
              <li class="dropdown user user-menu">
                ...
                <li><a href="../report_search/index.php?view=add2">Yearly Report Report</a></li>
                <!--
              ...
              <li class="dropdown user user-menu">
                ...
                <li><a href="../module/index.php?view=detail&id=1">Module Setting</a></li>
                <!--
                <li><a href="../product_select/index.php?view=list">Report 2</a></li>
                <li><a href="../report_search/index.php?view=list&rpt=exportExcel">Report 3</a></li>
                -->
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  -->
                  <!-- hidden-xs hides the username on small devices so only the image appears. -->
                  <span class="hidden-xs">MEMBER : <?php echo $_SESSION['user_name']; ?></span>
                </a>
                <ul class="dropdown-menu">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
              ...
              <img src="../upload_glsb/logo.png" width='210px' >
          ...
          <ul class="sidebar-menu">
            ...
            <li <?php if($current_folder == "wallet") { echo "class='active'"; }?>>
              <a href="#"><i class="fa fa-link"></i> <span>My E-Wallet</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                
                <li <?php if($_GET['wallet'] == "ewallet") { echo "class='active'"; }?>><a href="../wallet/index.php?view=list&wallet=ewallet">E-Wallet Transactions</a></li>
<li <?php if($_GET['wallet'] == "ewalletWithdraw") { echo "class='active'"; }?>><a href="../wallet/index.php?view=list&wallet=ewalletWithdraw"><?php echo $lang['MENU_E_WALLET_WITHDRAM_HISTORY']; ?></a></li>      
            ...
            <li <?php if($current_folder == "my_order") { echo "class='active'"; } ?>>
              <a href="#"><i class="fa fa-link"></i> <span>My Purchases</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
            <li><a href="../my_order/index.php?view=add"><i class="fa fa-link"></i> <span>Purchases Order</span></a></li>  
            <li><a href="../my_order/index.php?view=list&sub=myorder"><i class="fa fa-link"></i> <span>My Purchases</span></a></li>

            <li><a href="../my_order/index.php?view=list&sub=downlineorder"><i class="fa fa-link"></i> <span>My Biz Network Group Purchases</span></a></li>
                      
              </ul>
            </li>           

            <li <?php if($current_folder == "user") { echo "class='active'"; } ?>>
              <a href="#"><i class="fa fa-link"></i> <span>My Biz Network</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
            <li><a href="../user/index.php?view=list&sub=1"><i class="fa fa-link"></i> <span>LEVEL 1 Downlines</span></a></li>  
            <li><a href="../user/index.php?view=list&sub=2"><i class="fa fa-link"></i> <span>LEVEL 2 Downlines</span></a></li>            
            <li><a href="../user/index.php?view=list&sub=3"><i class="fa fa-link"></i> <span>LEVEL 3 Downlines</span></a></li>
            <li><a href="../user/index.php?view=treeview_binary&id=admin"><i class="fa fa-link"></i> <span>Tree View</span></a></li>
              </ul>
            </li>  
