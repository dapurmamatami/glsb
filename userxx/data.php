...
// get data and store in a json array
	...
	$viewAllSQL = 'where sponsor_id = ' . $user_id . '';
	$viewAllSQLFilter = 'and sponsor_id = ' . $user_id . '';

	if($_SESSION['user_grp'] == 1)
	{
		$viewAllSQL = 'where user_id > 1';
		$viewAllSQLFilter = 'and user_id > 1';		
	}
	else
	{
		$viewAllSQL = 'where sponsor_id = ' . $user_id . '';
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS * FROM user $viewAllSQL order by created_date desc LIMIT $start, $pagesize";
