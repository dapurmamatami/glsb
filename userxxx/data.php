...
// get data and store in a json array
	...
	{
		case '1' :
		$query = "SELECT SQL_CALC_FOUND_ROWS *, concat(address1,',',' ',postcode) as address1 FROM user left join user_status on user.status_id = user_status.status_id where upline_id = $user_id and user.status_id > 0 LIMIT $start, $pagesize"; 
		break;
		
		case '2' :
		$query = "SELECT SQL_CALC_FOUND_ROWS *, concat(address1,',',' ',postcode) as address1 FROM user left join user_status on user.status_id = user_status.status_id where upline_id2 = $user_id and user.status_id > 0  LIMIT $start, $pagesize"; 
		break;
		
		case '3' :
		$query = "SELECT SQL_CALC_FOUND_ROWS *, concat(address1,',',' ',postcode) as address1 FROM user left join user_status on user.status_id = user_status.status_id where upline_id3 = $user_id and user.status_id > 0  LIMIT $start, $pagesize"; 
		break;
