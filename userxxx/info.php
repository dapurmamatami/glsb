...
$(document).ready(function () {
	                  ...
	                  <?php } ?>                      
                                  ...
                                  <div class="tab-content">
 									...
 									<div class="form-group">												
											<label class="col-md-2 control-label">User ID</label>
											<div class="col-md-3">
												<input type="text" name="user_name" id="user_name" class="form-control" value="<?PHP echo $data['user_name']?>" <?php if($data['user_name'] <> '') { ?>disabled="disabled"
                                                <?php } ?> />
											</div>
            ...
            <?php
                                            	...
                                            	<label class="col-md-2 control-label">Bank Account Number</label>
											<div class="col-md-3">
												<input name="name" type="text" class="form-control" id="bank_account_no" value="<?PHP echo $data['bank_account_no']?>" />
											</div>
                                            </div>
...
$(document).ready(function () {
		...
		{	
			...
			columns: [ 
				...
				{ text: 'Name', editable: false, datafield: 'name', width: 180 },
				{ text: 'Member No',editable: false, datafield: 'member_reg_no', width: 100 },
				{ text: 'IC Number',editable: false, datafield: 'ic_no', width: 110 },
				{ text: 'Sponsor By',editable: false, datafield: 'sponsor_member_reg_no', width: 100 },
				{ text: 'Address',editable: false, datafield: 'address1', width: 300 },
				{ text: 'City',editable: false, datafield: 'city', width: 120 },
