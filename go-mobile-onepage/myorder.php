               ...
               <div class="swiper-wrapper">
                    <div class="swiper-slide">
                              <div class="slide-inner">
										...
										$sql = "SELECT *, sorder.so_id as so_id from sorder left join sorder_status on sorder_status.status_id = sorder.status_id where customer_id = '$user_id' order by sorder.so_id desc";
										$q = $pdo->prepare($sql);
										$q->execute();
										...
										if ($q->rowCount() > 0) {
											...
											<div class="toogle_wrap radius8">
												<div class="trigger"><a href="#">Order ID: <?php echo $row['so_id']; ?> - <?php echo $row['status_name']; ?></a></div>
												<div class="toggle_container">
                                                    <ul class="listing_detailed">
                                                    <li>Order Date : <?php echo $row['so_date']; ?></li>
                                                    <li>Total Amount: <?php echo $row['amount']; ?></li>
                                                    <li>Total PV : <?php echo $row['total_pv']; ?></li>
                                                    <li>Total Weight: <?php echo $row['total_weight_in_gram']; ?></li>
                                                    </ul>
												</div>
