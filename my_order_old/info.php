              ...
              <div class="box box-info">
                  <div class="box-body">                                   
                    <div class="col-md-12">
	                  ...
	                  <?php } ?>   
                      <input type="submit" value="Print" id="buttonPrint" class="btn btn-primary" onClick="document.theForm.action='info_inc.php?action=printReport&id=<?php echo $data[file_name]; ?>'"/>                
										</div>
                         </div>                       
                                  <div class="tab-content">
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
											<label class="col-md-2 control-label">Delivery Method  </label>
											<div class="col-md-2">
											<input name="courier_sw" id="courier_sw" type="radio" value="0" /> 
											Pickup &nbsp;&nbsp;&nbsp;&nbsp;
...
$(document).ready(function () {
		...
		{	
			...
			columns: [ 
				...
				{ text: 'Order ID',editable: false, datafield: 'so_id2', width: 80 },
				...
				{ text: 'Total Weight',editable: false, datafield: 'total_weight_in_gram', width: 100 },
				...
				<div class="box box-warning">
                  <div class="box-body">                                   
                    <div class="col-md-12">
                            ...
                            <form class="form-horizontal row-border" action="" method="post" name="theForm" id="theForm">
                                                         <input type="submit" value="Print" id="buttonPrint" class="btn btn-primary" onClick="document.theForm.action='info_inc.php?action=printReportAll&report_name=pending_approval&id=<?php echo $id; ?>'" formtarget="_blank"/>
                                                        </form>
